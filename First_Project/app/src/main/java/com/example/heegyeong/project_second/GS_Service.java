...
public class GS_Service extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gs__service);
    ...
    public void onClickDetail(View view){
        ...
        switch(view.getId()){
            case R.id.service_detail :
                intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://gs25.gsretail.com/gscvs/ko/store-services/gs25-in-everyday-life"));
                break;
    ...
    public void onServiceClick(View view){
        ...
        switch(view.getId()) {
            case R.id.service_btn_cu:
                intent = new Intent(GS_Service.this, CU_Service.class);
                break;
            case R.id.service_btn_gs:
                intent = new Intent(GS_Service.this, GS_Service.class);
                break;
            case R.id.service_btn_eleven:
                intent = new Intent(GS_Service.this, Eleven_Service.class);
                break;
            case R.id.service_btn_mini:
                intent = new Intent(GS_Service.this, Mini_Service.class);
                break;
        }
        if(intent != null)
            startActivity(intent);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_gs_, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 4:
                    return SectionsFragment5.newInstance(position + 1);
                // tab 추가시 case 추가
    ...
    public static class SectionsFragment1 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.gs_service_life, container, false);
    ...
    public static class SectionsFragment2 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.gs_service_post, container, false);
    ...
    public static class SectionsFragment3 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.gs_service_public, container, false);
    ...
    public static class SectionsFragment4 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.gs_service_giftcard, container, false);
            return rootView;
        }
    }

    public static class SectionsFragment5 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.gs_service_ticket, container, false);
            return rootView;
        }
    }
}
