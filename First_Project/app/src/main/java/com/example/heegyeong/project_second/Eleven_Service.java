...
public class Eleven_Service extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eleven__service);
    ...
    public void onServiceClick(View view){
        ...
        switch(view.getId()) {
            case R.id.service_btn_cu:
                intent = new Intent(Eleven_Service.this, CU_Service.class);
                break;
            case R.id.service_btn_gs:
                intent = new Intent(Eleven_Service.this, GS_Service.class);
                break;
            case R.id.service_btn_eleven:
                intent = new Intent(Eleven_Service.this, Eleven_Service.class);
                break;
            case R.id.service_btn_mini:
                intent = new Intent(Eleven_Service.this, Mini_Service.class);
                break;
        }
        if(intent != null)
            startActivity(intent);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_eleven_, container, false);
    ...
    public static class SectionsFragment1 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.eleven_service_life, container, false);
    ...
    public static class SectionsFragment2 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.eleven_service_post, container, false);
    ...
    public static class SectionsFragment3 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.eleven_service_public, container, false);
    ...
    public static class SectionsFragment4 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.eleven_service_giftcard, container, false);
            return rootView;
        }
    }
    ...
    public static class SectionsFragment5 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.eleven_service_inex, container, false);
            return rootView;
        }
    }
}
