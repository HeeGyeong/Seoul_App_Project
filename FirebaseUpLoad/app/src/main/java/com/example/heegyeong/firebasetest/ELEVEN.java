...
/**
 * Created by Heegyeong on 2016-11-24.
 */
public class ELEVEN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.elevenlayout);

        btn = (Button) findViewById(R.id.buttoneleven);
            ...
            public void onClick(View view) {
                ...
                while (true) {
                    if (i >= arrayListFood[0].size()) {
                        ...
                        baseURL[i] = "http://"+ arrayListFood[0].get(i);
                        ...
                        if (product_name[i] != null) {
                            ...
                            databaseReference.child("product").child("eleven").push().setValue(product);
                        }
                        i++;
                    }
                }
                ...
                while (true) {
                    if (i >= arrayListIce[0].size()) {
                        ...
                        baseURL[i] = "http://"+ arrayListIce[0].get(i);
                ...
                while (true) {
                    if (i >= arrayListSnack[0].size()) {
                        ...
                        baseURL[i] =  "http://"+ arrayListSnack[0].get(i);
                ...
                while (true) {
                    if (i >= arrayListDrink[0].size()) {
                        ...
                        baseURL[i] = "http://"+ arrayListDrink[0].get(i);
                ...
                while (true) {
                    if (i >= arrayListDaily[0].size()) {
                        ...
                        baseURL[i] = "http://"+ arrayListDaily[0].get(i);
    ...
    public void loadTxtDrink() {
        InputStream inputData1 = getResources().openRawResource(R.raw.elevendrinkurl);
        InputStream inputData2 = getResources().openRawResource(R.raw.elevendrinkname);
        InputStream inputData3 = getResources().openRawResource(R.raw.elevendrinkprice);
        InputStream inputData4 = getResources().openRawResource(R.raw.elevendrinkevent);
        for(int i=0;i<4;i++){
    ...
    public void loadTxtFood(){
        InputStream inputData1 = getResources().openRawResource(R.raw.elevenfoodurl);
        InputStream inputData2 = getResources().openRawResource(R.raw.elevenfoodname);
        InputStream inputData3 = getResources().openRawResource(R.raw.elevenfoodprice);
        InputStream inputData4 = getResources().openRawResource(R.raw.elevendrinkevent);
        for(int i=0;i<4;i++){
    ...
    public void loadTxtIce(){
        InputStream inputData1 = getResources().openRawResource(R.raw.eleveniceurl);
        InputStream inputData2 = getResources().openRawResource(R.raw.elevenicename);
        InputStream inputData3 = getResources().openRawResource(R.raw.eleveniceprice);
        InputStream inputData4 = getResources().openRawResource(R.raw.eleveniceevent);
        for(int i=0;i<4;i++){
    ...
    public void loadTxtSnack(){
        InputStream inputData1 = getResources().openRawResource(R.raw.elevensnackurl);
        InputStream inputData2 = getResources().openRawResource(R.raw.elevensnackname);
        InputStream inputData3 = getResources().openRawResource(R.raw.elevensnackprice);
        InputStream inputData4 = getResources().openRawResource(R.raw.elevensnackevent);
        for(int i=0;i<4;i++){
    ...
    public void loadTxtDaily(){
        InputStream inputData1 = getResources().openRawResource(R.raw.elevendailyurl);
        InputStream inputData2 = getResources().openRawResource(R.raw.elevendailyname);
        InputStream inputData3 = getResources().openRawResource(R.raw.elevendailyprice);
        InputStream inputData4 = getResources().openRawResource(R.raw.elevendailyevent);
        for(int i=0;i<4;i++){
